...
class UMTS_Fragment : Fragment(), OnMapReadyCallback {

    override fun onCreateView(inflater: LayoutInflater?, container: ViewGroup?, savedInstanceState: Bundle?): View {
        // Riempie la View con UMTS Layout
        return inflater!!.inflate(R.layout.umts_fragment, container, false)
    }
    ...
    override fun onViewCreated(view: View?, savedInstanceState: Bundle?) {
        ...
        // Imposta il titolo dell'Activity a "UMTS"
        activity.setTitle(R.string.umts)

        // Recupera il Fragment in cui mostrare la UMTS Map (la mappa con solo il segnale UMTS)
        ...
        val mapFragment = childFragmentManager.findFragmentById(R.id.umts_map) as MapFragment
